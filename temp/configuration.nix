...
{ imports =
  ...
  i18n.extraLocaleSettings = { LC_ADDRESS = "en_IN"; LC_IDENTIFICATION = "en_IN"; LC_MEASUREMENT = "en_IN"; LC_MONETARY = "en_IN"; LC_NAME = "en_IN"; 
    LC_NUMERIC = "en_IN"; LC_PAPER = "en_IN"; LC_TELEPHONE = "en_IN"; LC_TIME = "en_IN";
  };
  ...
  users.users.arpiku = { isNormalUser = true; description = "arpiku"; extraGroups = [ "networkmanager" "wheel" ]; packages = with pkgs; [
      firefox
    #  thunderbird
    ];
  };
  ...
  nixpkgs.config = {
  allowUnfree = true;  # Optional, allows unfree packages if needed
  ...
  # were taken. It‘s perfectly fine and recommended to leave this value at the release version of the first install of this system. Before changing 
  # this value read the documentation for this option (e.g. man configuration.nix or on https://nixos.org/nixos/options.html).
